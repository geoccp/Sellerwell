package org.jeecg.modules.geek.geekProductSearch.entity;
 ...
 */
@Data
@TableName("geek_product_search")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="geek_product_search对象", description="geek_product_search")
public class GeekProductSearch implements Serializable {
