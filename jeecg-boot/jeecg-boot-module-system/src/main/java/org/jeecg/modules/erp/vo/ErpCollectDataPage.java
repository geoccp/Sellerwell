 ...
 */
@Data
@ApiModel(value="erp_collect_dataPage对象", description="erp_collect_data")
public class ErpCollectDataPage {
	...
	@ExcelCollection(name="erp_collect_language")
	@ApiModelProperty(value = "erp_collect_language")
	private List<ErpCollectLanguage> erpCollectLanguageList;
	@ExcelCollection(name="erp_collect_image")
	@ApiModelProperty(value = "erp_collect_image")
	private List<ErpCollectImage> erpCollectImageList;
