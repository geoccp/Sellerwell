<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('geek_all_product_search')">导出</a-button>
    ...
    <geek-all-product-search-modal ref="modalForm" @ok="modalFormOk"></geek-all-product-search-modal>
  </a-card>
</template>
...
<script>
  ...
  import GeekAllProductSearchModal from './modules/GeekAllProductSearchModal'

  export default {
    name: 'GeekAllProductSearchList',
    mixins:[JeecgListMixin, mixinDevice],
    components: {
      GeekAllProductSearchModal
    },
    data () {
      return {
        description: 'geek_all_product_search管理页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/geekAllProductSearch/geekAllProductSearch/list",
          delete: "/geekAllProductSearch/geekAllProductSearch/delete",
          deleteBatch: "/geekAllProductSearch/geekAllProductSearch/deleteBatch",
          exportXlsUrl: "/geekAllProductSearch/geekAllProductSearch/exportXls",
          importExcelUrl: "geekAllProductSearch/geekAllProductSearch/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'price',text:'价格'})
        fieldList.push({type:'string',value:'productId',text:'编码'})
